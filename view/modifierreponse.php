   ...
   <div class="main-header">
    ...
    <div class="header-menu">
     ...
     <a class="main-header-link is-active" href="tous _rec.php">Reports</a>
        ...
        <table style="position:relative; top: 0px; left: 150px; width: 380px;height :216px; " >
                                      
        <tr>
                                               <td style="color: black; position: relative; top: 35px;"><label for="date" >ID</label></td>
                                               <td style="position: relative; left: 25px; top: 38px;"><input type="text" name="id" id="date" value="<?php echo $reponse['id_reponse']; ?>"></td>
                                           </tr>                               
                                           
        <tr>
                                               <td style="color: black; position: relative; top: 42px;"><label for="date">Date</label></td>
                                               <td style="position: relative; left: 25px; top: 38px;"><input type="date" name="date" id="date" value="<?php echo $reponse['date_reponse']; ?>"></td>
                                           </tr>
                                        
                                            <tr>
                                               <td style="color: black; position: relative; top: 58px;"><label for="email">Email</label></td>
                                               <td style="position: relative; left: 25px; top: 56px;"><input type="email" name="email" id="email" value="<?php echo $reponse['mail_reponse']; ?>"></td>
                                           </tr>
                                       
                                        
                                           <tr>
                                               <td style="color: black; position: relative; top: 110px;"><label for="sujet">Sujet</label></td>
                                               <td style="position: relative; left: 25px; top: 100px;"><input type="text" name="sujet" id="sujet" value="<?php echo $reponse['sujet_reponse']; ?>"></td>
                                           </tr>
                                           ...
                                           <tr>
                                               ...
                                               <td style="position: relative; left: 25px; top:140px"><input name="message" id="message" cols="50" rows="10" placeholder="Description et vos Remarques..." value="<?php echo $reponse['description_reponse']; ?>"></td>
                                           </tr>
                                           <tr>
                                               <td ><input style="position: relative; left: 100px; top: 200px;" type="submit" value="Modifier"></td>
