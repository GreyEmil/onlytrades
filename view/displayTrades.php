                    ...
                    for ($i = 0; $i < count($trades); $i++) {
                        if ($trades[$i]["status"] =="APPROVED" && $trades[$i]["type"]==1 &&  $_SESSION['user']["id"]!=$trades[$i]["id_user"]) {
                            ...
                            echo " <div id='wraper' class='col-lg-4 col-sm-6 trade' style='margin-right:20px' >
                                    ...
                                    echo '<img src="data:image;base64,' . $trades[$i]["image"]. '" alt="image" style="width:380px; height:388px;">';
                            ...
                            echo "</div>
                                <div class='accessories-content'>
                                    <h5 ><a class='name' href='./viewtrade.php?trade=" . $trades[$i]["id"] . "'>
                                    " . $trades[$i]['name'] . "</a>
                                    </h5><span>category: " . $trades[$i]['category'] . " </span>
                                    <a href='./viewtrade.php?trade=" . $trades[$i]["id"] . "' class='shop-add-action'>Trade</a>
                                    </div>
                                    </div>
                                </div>";
  ...
  <!-- footer-area-end -->
    ...
    <script>
        ...
        function filterList() {
            ...
            const listCards = document.querySelectorAll("#wraper>*");
