...
<body>
    ...
    <script>
        ...
        function setTimer()
        {
            ...
            {
                var id=<?php echo $_SESSION["temp"]["id"]; ?>;
    ...
    <script>
        onload=()=>
        {
        let src1='data:image/jpeg;base64,'+'<?php if(isset($_SESSION["temp"]["images"][0]["bin"])) echo $_SESSION["temp"]["images"][0]["bin"]; ?>';
        let src2='data:image/jpeg;base64,'+'<?php if(isset($_SESSION["temp"]["images"][1]["bin"])) echo $_SESSION["temp"]["images"][1]["bin"]; ?>';
        let src3='data:image/jpeg;base64,'+'<?php if(isset($_SESSION["temp"]["images"][2]["bin"])) echo $_SESSION["temp"]["images"][2]["bin"]; ?>';
        let src4='data:image/jpeg;base64,'+'<?php if(isset($_SESSION["temp"]["images"][3]["bin"])) echo $_SESSION["temp"]["images"][3]["bin"]; ?>';
        let src5='data:image/jpeg;base64,'+'<?php if(isset($_SESSION["temp"]["images"][4]["bin"])) echo $_SESSION["temp"]["images"][4]["bin"]; ?>';
