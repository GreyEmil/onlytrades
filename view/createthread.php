                                        ...
                                        <tbody>
                                            <tr>
                                                <th scope="row">
                                                    <div class="col-lg-12">
                                                        <div class="col-lg-12">
                                                        <form action="../controller/addNewThread.php" method="POST">
                                                            <label for="subject" class="newthread-label"> Subject</label>
                                                            <input id="subject" name="subject" type="textarea" class="newthread-input" >
                                                            <label for="content" class="newthread-label">Thread Content</label>
                                                            <textarea name="content" id="content" cols="30" rows="10"  class="newthread-input"></textarea>
                                                            
                                                            <input type="text" name="category" value="<?php echo $_GET["category"];?>" style="display:none">
                                                            <button type="submit" id="submit" class="submit" style="display:block">submit</button>
                                                        </form>
                                                        </div>
                                                    </div>
                                                </th>
  ...
  <!-- footer-area-end -->
    ...
    $.fn.selectCF = function( options ) {
        ...
        return this.each(function(){
			...
			html += 		"<span class='titleCF' style='"+style+"; width:100px'>"+title+"</span>";
