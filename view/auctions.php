                ...
                <div class="row">
                    <div class="col-12">
                        <div class="main-menu menu-style-two">
                            <nav>
                                <div class="logo">
                                    <a href="index.php"><img src="img/logo/logo.png" id="logo" class="logoh" alt="logo"></a>
                                </div>
                ...
                <div class="released-game-carousel">
                    <div class="released-game-item-fares">
                        ...
                        <div class="released-game-content">
                            ...
                            <a href="../controller/viewAuction.php?selectedAuction='.$_SESSION["auctions"][$i]["id"].'" class="btn btn-style-two">Enter Auction</a>
                        </div>
        ...
        $(document).ready(function(){
            ...
            for(var element of auctions)
            {
                ...
                if(timer.trim()=='Auction Is Ongoing!') 
                {
                    ...
                    $(element).find('a').attr('href','../controller/viewOnGoingAuction.php?selectedAuction='+id);
                }
            }
        })
    </script>
