                ...
                <div class="breadcrumb-content text-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="myOnGoingTrades.php">OnGoingTrades</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Done Deals</li>
                                </ol>
                            </nav>
                        </div>
            </section>
                        ...
                        <div class="row " >
                          <div class="col ">
                            <div class="latest-match-box mb-30">
                                <div class="latest-match-thumb"><img style="width:131px; height:161px;" src="data:image;base64,<?php echo $doneDeals[$i]["side1"]["images"][0] ?>" alt=""></div>
                                <div class="tournament-schedule-content" style="width:100%">
                                <h3><span><?php echo $doneDeals[$i]["side1"]["user"]["username"] ?></span></h3>
                                <h3><?php echo $doneDeals[$i]["side1"]["name"] ?></h3>
                                <h3 ><?php echo $doneDeals[$i]["side1"]["description"] ?></h3>
                                </div>
                            </div>
                          </div>
                          <div class="col-md-auto" style="margin: auto;">
                          <img src="./img/icon/tradeCart.png" alt="">
                          </div>
                          <div class="col ">
                            <div class="latest-match-box mb-30" >
                                <div class="latest-match-thumb"><img style="width:131px; height:161px;" src="data:image;base64,<?php echo $doneDeals[$i]["side2"]["images"][0] ?>" alt=""></div>
                                <div class="tournament-schedule-content" style="width:100%">
                                <h3><span><?php echo $doneDeals[$i]["side2"]["user"]["username"] ?></span></h3>
                                <h3><?php echo $doneDeals[$i]["side2"]["name"] ?></h3>
                                <h3 ><?php echo $doneDeals[$i]["side2"]["description"] ?></h3>
                                </div>
                            </div>   
                          </div>
                          </div>                         
