...
<head>
    ...
    <?php
    require_once "../model/p2.php";
    session_start();
    $user = $_SESSION["currentuser"];
    $data=Product2::retrievData();
    ?>
    <body>
            ...
            <section id="section" class="game-manage-area game-mange-bg pt-120 pb-120">
                <div class="container">
                    ...
                    <div class="row justify-content-center">
                        ...
                        for ($i=0 ; $i<count($data["product1"]); $i++){
                            if($data["product1"][$i]["user_id"]==$user){
                         echo '
                            <div class="coming-match-item mb-30">
                                <div class="coming-match-team">
                                    <div class="match-team-info">
                                        <div class="match-team-logo">';
                                            for($j=0 ; $j<count($data["file1"]) ; $j++){
                                                if($data["file1"][$j]["product_id"]== $data["product1"][$i]["id"]){
                                           echo' <a href="#"><img src="data:image;base64,' . base64_encode($data["file1"][$j]["data"]) . '" alt="image" style="width:91px; height:92px;"></a>
                                        </div>';
                                        break;}}
                                        echo '<div class="match-team-name">
                                            <a href="#">'.$data["product1"][$i]["name"].'</a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="match-team-info">';
                                     for($j=0 ; $j<count($data["product2"]) ; $j++){ 
                                        if($data["product2"][$j]["id_product"]==$data["product1"][$i]["id"]){
                                       echo' <a href="#"><img src="data:image;base64,' . base64_encode($data["file2"][$j]["data"]) . '" alt="image" style="width:91px; height:92px;"></a>
                                        </div>';
                                        break;}}
