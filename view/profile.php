...
<body>
    ...
    <main>
        ...
        <section class="breadcrumb-area breadcrumb-bg3">
            ...
            <section class="page-content">
                ...
                <section class="grid">
                    <img class="profile-image" src="data:image/jpeg;base64,<?php echo $_SESSION["user"]["photo"]; ?>" alt="">
                    <article style="margin-left:-450px;height:440px;font-family: 'Oxanium', cursive;">
                    <div style="width:600px;word-break: break-all;">
                        <ul>
                            <li class="profile-li"><span class="profile-span">Username :</span><br><?php echo $_SESSION["user"]["username"]; ?></li>
                            <li class="profile-li"><span class="profile-span">First name :</span><br><?php echo $_SESSION["user"]["first_name"]; ?></li>
                            <li class="profile-li"><span class="profile-span">Last name :</span><br><?php echo $_SESSION["user"]["last_name"]; ?></li>
                            <li class="profile-li"><span class="profile-span">Date of birth :</span><br><?php echo $_SESSION["user"]["dob"]; ?></li>
                    ...
                    <div style="width:634px;">
                        <ul>
                            <li class="profile-li"><span class="profile-span">Email :</span><br><?php echo $_SESSION["user"]["email"]; ?></li>
                            <li class="profile-li"><span class="profile-span">Phone number :</span><br><?php echo $_SESSION["user"]["phone"]; ?></li>
                            <li class="profile-li"><span class="profile-span">Adress :</span><br><?php echo $_SESSION["user"]["adress"]; ?></li>
                            <li class="profile-li"><span class="profile-span">Zip code :</span><br><?php echo $_SESSION["user"]["zip_code"]; ?></li>
                        </ul>
                    </div>
                    <div style="position:absolute;right:40px;top:435px"><a href="">Edit personal info</a></div>
                    </article>
                    <article>
                        <ul>
                        <?php if(isset($_SESSION["ownedAuctions"][0]))
                        {
                            echo '
                            <li class="profile-li"><span class="profile-span">Auction 1 :</span><br></li>
                            <li class="profile-li"><span class="profile-span">Item Name :</span><br>'.$_SESSION["ownedAuctions"][0]["name"].'</li>
                            <li class="profile-li"><span class="profile-span">Item Name :</span><br>'.$_SESSION["ownedAuctions"][0]["startDate"].'</li>
                        ';
                        } ?>
                        </ul>
                    </article>
    ...
    <footer>
        <div class="footer-top footer-bg s-footer-bg">
                            ...
                            <div class="footer-text">
                                ...
                                <div class="footer-contact">
                                    <ul>
                                        ...
                                        <li><i class="fas fa-envelope-open"></i><span>Email : </span><a href="https://themebeyond.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="761f18101936130e131b061a135815191b">[email&#160;protected]</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
            ...
            <div class="footer-fire footer-fire-right"><img src="img/images/footer_axe.png" height="306px" alt="axe_footer"></div>
