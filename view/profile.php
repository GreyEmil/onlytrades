                ...
                <div class="row">
                    <div class="col-12">
                        <div class="breadcrumb-content text-center">
                            <h2><?php echo $user['username'] . "'s" . "&nbsp;" ?><span>Profile</span></h2>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-10 pl-100">
                        <div class="section-title title-style-three mb-20">
                            <h2>About <span><?php echo $user['username']  ?></span></h2>
                        </div>
                        <div class="contact-info-list mb-30">
                            <ul>
                                <li><img src="data:image/jpeg;base64,<?php echo $_SESSION["user"]["photo"] ?>" alt="" style="max-width:200px;max-height:200px;width:100%;height:100%;border-radius:20px;"></li>
                                <li><i class="fas fa-user-alt mb-30"></i><?php echo "Firstname :" . "&nbsp;" . $_SESSION["user"]["first_name"] ?></li>
                                <li><i class="fas fa-user-alt mb-30"></i><?php echo "Lastname :" . "&nbsp;" .$_SESSION["user"]["last_name"] ?></li>
                                <li><i class="fas fa-envelope mb-30"></i><a class="__cf_email__" data-cfemail="7c15121a133c1f10130904521f1311"></a><?php echo "Email :" . "&nbsp;" . $_SESSION["user"]["email"]  ?></li>
                                <li><i class="fas fa-calendar-alt mb-30"></i><?php echo "Birthdate :" . "&nbsp;" . $_SESSION["user"]["dob"] ?></li>
                                <li><i class="fas fa-calendar-times mb-30"></i><?php echo "Joined us at :" . "&nbsp;" . $_SESSION["user"]["creation_date"] ?></li>
                                <li><i class="fas fa-calendar-times mb-30"></i><?php echo "My points:" . "&nbsp;" . $_SESSION["user"]["points"] ?></li>
                            </ul>
                        </div>
