                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 pl-100">
                        ...
                        <div class="contact-info-list mb-30">
                            <ul>
                                <li><i class="fas fa-user-alt mb-30"></i><?php echo "Firstname :" . "&nbsp;" . $user['last_name'] ?></li>
                                <li><i class="fas fa-user-alt mb-30"></i><?php echo "Lastname :" . "&nbsp;" . $user['last_name'] ?></li>
                                <li><i class="fas fa-envelope mb-30"></i><a class="__cf_email__" data-cfemail="7c15121a133c1f10130904521f1311"></a><?php echo "Email :" . "&nbsp;" . $user['email']  ?></li>
                                <li><i class="fas fa-calendar-alt mb-30"></i><?php echo "Birthdate :" . "&nbsp;" . $user['birthdate'] ?></li>
                                <li><i class="fas fa-calendar-times mb-30"></i><?php echo "Joined us at :" . "&nbsp;" . $user['create_datetime'] ?></li>
                            </ul>
                        </div>
